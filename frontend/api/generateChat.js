...
export default async function generateChat(req, res) {
  ...
  try {
    ...
    const chatCompletion = await openai.chat.completions.create({
      model: "gpt-4o-mini",
      messages: [
        { role: "system", content: "You are a Mexican Spanish short story generator." },
        {
          role: "user",
          content: prompt,
        },
  ...
  switch (skillLevel) {
    case "beginner":
      prompt =
        ...
        "Create a short story of 3-5 sentences, using elementary spanish, where all of the verbs are in the present tense. You must use every single one of the following words: " + words;
      break;
    case "intermediate":
      prompt =
        ...
        "Create a short story of 3-5 sentences, using intermediate spanish. You must use every single one of the following words: " + words;
      break;
    case "advanced":
      prompt =
        ...
        "Create a short story of 3-5 sentences, using advanced spanish. You must use every single one of the following words: " + words;
      break;
    default:
